...
const coreUrls = [
  ...
  './styles.css?v=20260816-meeting-continuous-v63',
  './app.js?v=20260816-meeting-continuous-v63',
  './pwa.js?v=20260816-meeting-continuous-v63'
];
...
assert.match(workerSource, /power-tbm-offline-[\s\S]*?v63-20260816/);
