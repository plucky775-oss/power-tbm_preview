(() => {
  'use strict';
  const scenes = [
    { at: 0, label: '관리자 메뉴', src: '01-admin-v75.png', title: ['관리자 화면에서', '4컷 카툰 제작'], description: '마지막으로, 사고예방 교육을 위한 안전 4컷입니다. 관리자 메뉴에서 ‘4컷카툰 제작’을 눌러 시작합니다.', points: ['관리자 메뉴', '4컷카툰 제작', '안전교육'], caption: '‘4컷카툰 제작’을 눌러 시작합니다', focus: [6.8, 25.8, 24.3, 5.2], gesture: { from: [75, 68], to: [19, 28.4], start: 4.1, arrive: 6.1, tap: 6.5, end: 7.8 } },
